...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation TTFixedWidthButton
...
+ (TTFixedWidthButton*)buttonWithStyle:(NSString*)selector {
    TTFixedWidthButton* button = [[[self alloc] init] autorelease];
...
- (CGSize)sizeThatFits:(CGSize)size {
    ...
    TTStyle* style = [self styleForCurrentState];
    if (style) {
        CGSize styleSize = [style addToSize:CGSizeZero context:context];
        return CGSizeMake(_width, styleSize.height);
    } else {
        return size;
    }
}
